...
{form?.isBooked? <p style={{"color":"black"}}>status : <div style={{"display":"inline"}} className='text-green-400  '>Approved</div> </p>:
          (form?.isApproved? <p style={{"color":"black"}}>status : <div style={{"display":"inline"}} className='  '>Under process</div> </p> : <p style={{"color":"black"}}>status : <div style={{"display":"inline"}} className='text-orange-700'> Pending</div> </p>)}
